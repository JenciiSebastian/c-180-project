...
function render_elements() {
    $.ajax({
        url: "https://api.openweathermap.org/data/2.5/weather?lat-${coordinates.destination_lat)Blon-$(coordinates.destination_lon}&appid-94212e971d8ca977383f8ae892224bbd",
        type: "get",
